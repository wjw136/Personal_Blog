...
CREATE TABLE `tbl_category_info` (
                                 ...
                                 `modified_by` datetime NOT NULL default CURRENT_TIMESTAMP COMMENT '分类修改时间',
                                 PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_article_info` (
                                    ...
                                    `modified_by` datetime NOT NULL default CURRENT_TIMESTAMP COMMENT '修改日期',
                                    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_article_content` (
                                       ...
                                       `create_by` datetime NOT NULL default CURRENT_TIMESTAMP COMMENT '创建时间',
                                       `modified_by` datetime NOT NULL default CURRENT_TIMESTAMP COMMENT '更新时间',
                                       PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
